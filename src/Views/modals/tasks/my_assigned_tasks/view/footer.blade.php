...
@include('laravel_task_manager::modals.tasks.my_assigned_tasks.view.helpers.style')
@include('laravel_task_manager::modals.tasks.my_assigned_tasks.view.helpers.script')
