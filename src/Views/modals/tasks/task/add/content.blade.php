...
<form class="form-horizontal form_task_add" id="form_task_add" name="form_task_add">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade" id="schedule">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <div class="radio-inline"><label for="schedule_begin_by_date"><input type="radio" class="schedule_begin_by_date" id="schedule_begin_by_date" name="schedule_begin_by" value="date" checked="checked" />در تاریخ</label></div>
                </div>
                <div class="col-sm-2">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1" style="margin-top: 10px;">
                    <div class="radio-inline"><label for="schedule_end_by_date"><input type="radio" class="schedule_end_by_date" id="schedule_end_by_date" name="schedule_end_by" value="date" checked="checked" />در تاریخ</label></div>
                </div>
                ...
                <div class="col-sm-2">
                    <div class="radio-inline">
                        <label for="schedule_end_by_recur"><input type="radio" class="schedule_end_by_recur" id="schedule_end_by_recur" name="schedule_end_by" value="recur" />بعد از</label>&nbsp;&nbsp;<input type="text" class="form-control schedule_end_by_recur_value" id="schedule_end_by_recur_value" name="schedule_end_value" style="width: 50px; display: inline-block;" disabled="disabled" value="" />&nbsp;&nbsp;<label class="" for="schedule_end_by_recur_value">رویداد</label>
                    </div>
                </div>
    ...
    <!-- tabs: end / content: start -->
    <button type="submit" class="submit_form_task_add hidden"></button>
</form>
